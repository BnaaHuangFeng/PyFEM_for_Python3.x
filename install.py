...
print(" Python version detected     " + versionLong[0] + ':', end=' ')

if int(version[0]) == 3 and int(version[1]) >= 6:
    print(" OK")
else:
    print(" Not OK\n\n   Please install Python 3.6.x or higher\n")
...
print(" Numpy version detected      " + versionLong + ':', end=' ')
...
print(" Scipy version detected      " + versionLong + ':', end=' ')
...
print(" Matplotlib version detected " + versionLong + ':', end=' ')
